---
name: figma-to-code
description: Use the figwright MCP (mcp__figwright__*) to read Figma designs and build UI from them. Use whenever the user mentions Figma, figwright, a Figma node id like 2252:3420, a figma.com URL, or "match the design".
---

# figwright

Tools are `mcp__figwright__<name>`. Node ids look like `2252:3420`. A URL with `node-id=2252-3420` means id `2252:3420`.
